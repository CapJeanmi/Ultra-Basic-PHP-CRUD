<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @if (auth()->user()->is_admin)
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                        <x-jet-nav-link href="{{ route('bills') }}" :active="request()->routeIs('bills')">
                            {{ __('Facturas') }}
                        </x-jet-nav-link>
                    </div>
                    <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
    ...
    <div :class="{ 'block': open, 'hidden': !open }" class="hidden sm:hidden">
        ...
        @if (auth()->user()->is_admin)
            ...
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="{{ route('bills') }}" :active="request()->routeIs('bills')">
                    {{ __('Facturas') }}
                </x-jet-responsive-nav-link>
            </div>
        @else
            <div class="pt-2 pb-3 space-y-1">
                <x-jet-responsive-nav-link href="{{ route('purchase') }}" :active="request()->routeIs('purchase')">
                    {{ __('Comprar') }}
                </x-jet-responsive-nav-link>
            </div>
        @endif
